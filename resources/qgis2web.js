...
map.getView().fit([12238946.909492, -828670.095368, 12263559.051619, -803123.895238], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Sekolah Temanggung</h2>';
        return titleElement;
    })(),
